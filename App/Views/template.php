...
<head>
  ...
  <title>Simple system finance | Simple Finance</title>
  ...
  <link rel="stylesheet" href="<?= BASE; ?>App/Assets/dist/css/skins/skin-blue.min.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?= BASE; ?>" class="logo">
      ...
      <span class="logo-lg"><b>Simple</b>Finance</span>
    </a>
        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="<?= BASE; ?>App/Assets/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="<?= BASE; ?>App/Assets/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
    ...
    <section class="sidebar">
     ...
     <!--  <form action="#" method="get" class="sidebar-form">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="<?= BASE; ?>"><i class="fa fa-tachometer"></i> <span>DASHBOARD</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= BASE; ?>client/add">Cliente</a></li>
            <li><a href="<?= BASE; ?>debit">Debito</a></li>
          </ul>
        </li>

        <li class="treeview">
          <a href="#"><i class="fa fa-users"></i> <span>Listar</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
